...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataStringType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataString
 */
class ODMcomplexTypeDefinitionItemDataStringType
{
