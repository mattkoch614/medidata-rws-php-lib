...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataBooleanType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataBoolean
 */
class ODMcomplexTypeDefinitionItemDataBooleanType
{
