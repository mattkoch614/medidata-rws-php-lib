...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataHexFloatType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataHexFloat
 */
class ODMcomplexTypeDefinitionItemDataHexFloatType
{
