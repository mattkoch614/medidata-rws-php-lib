...
/**
 * Class representing ODMcomplexTypeDefinitionCodeListItemType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-CodeListItem
 */
class ODMcomplexTypeDefinitionCodeListItemType
{
    ...
    /**
     * @property \Medidata\RwsPhp\Schema\ODM\Decode $decode
     */
    private $decode = null;
     ...
     * Gets as decode
     *
     * @return \Medidata\RwsPhp\Schema\ODM\Decode
     */
     ...
     * Sets a new decode
     *
     * @param \Medidata\RwsPhp\Schema\ODM\Decode $decode
     * @return self
     */
    public function setDecode(\Medidata\RwsPhp\Schema\ODM\Decode $decode)
    {
        $this->decode = $decode;
        return $this;
    }
