...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataHexBinaryType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataHexBinary
 */
class ODMcomplexTypeDefinitionItemDataHexBinaryType
{
