...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataDurationDatetimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataDurationDatetime
 */
class ODMcomplexTypeDefinitionItemDataDurationDatetimeType
{
