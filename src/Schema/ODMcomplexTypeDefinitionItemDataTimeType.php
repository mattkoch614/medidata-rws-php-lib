...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataTimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataTime
 */
class ODMcomplexTypeDefinitionItemDataTimeType
{
