...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataPartialDateType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataPartialDate
 */
class ODMcomplexTypeDefinitionItemDataPartialDateType
{
