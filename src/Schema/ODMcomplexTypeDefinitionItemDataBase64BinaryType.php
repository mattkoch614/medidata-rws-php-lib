...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataBase64BinaryType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataBase64Binary
 */
class ODMcomplexTypeDefinitionItemDataBase64BinaryType
{
