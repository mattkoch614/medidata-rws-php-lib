...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataIntegerType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataInteger
 */
class ODMcomplexTypeDefinitionItemDataIntegerType
{
