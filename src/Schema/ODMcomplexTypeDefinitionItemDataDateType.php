...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataDateType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataDate
 */
class ODMcomplexTypeDefinitionItemDataDateType
{
