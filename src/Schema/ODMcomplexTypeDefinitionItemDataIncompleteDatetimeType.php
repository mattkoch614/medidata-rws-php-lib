...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataIncompleteDatetimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataIncompleteDatetime
 */
class ODMcomplexTypeDefinitionItemDataIncompleteDatetimeType
{
