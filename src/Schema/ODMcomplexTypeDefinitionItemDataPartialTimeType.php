...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataPartialTimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataPartialTime
 */
class ODMcomplexTypeDefinitionItemDataPartialTimeType
{
