...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataDoubleType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataDouble
 */
class ODMcomplexTypeDefinitionItemDataDoubleType
{
