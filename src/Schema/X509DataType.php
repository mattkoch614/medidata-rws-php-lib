...
class X509DataType
{
    ...
    /**
     * @property \Medidata\RwsPhp\Schema\xmldsig\X509IssuerSerialType[]
     * $x509IssuerSerial
     */
     ...
     *
     * @return self
     * @param \Medidata\RwsPhp\Schema\xmldsig\X509IssuerSerialType $x509IssuerSerial
     */
    public function addToX509IssuerSerial(\Medidata\RwsPhp\Schema\xmldsig\X509IssuerSerialType $x509IssuerSerial)
    {
     ...
     *
     * @return \Medidata\RwsPhp\Schema\xmldsig\X509IssuerSerialType[]
     */
