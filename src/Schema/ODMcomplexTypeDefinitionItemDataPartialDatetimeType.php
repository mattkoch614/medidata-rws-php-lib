...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataPartialDatetimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataPartialDatetime
 */
class ODMcomplexTypeDefinitionItemDataPartialDatetimeType
{
