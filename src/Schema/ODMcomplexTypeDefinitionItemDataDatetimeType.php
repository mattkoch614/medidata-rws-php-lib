...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataDatetimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataDatetime
 */
class ODMcomplexTypeDefinitionItemDataDatetimeType
{
