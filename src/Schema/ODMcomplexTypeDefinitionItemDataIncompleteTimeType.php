...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataIncompleteTimeType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataIncompleteTime
 */
class ODMcomplexTypeDefinitionItemDataIncompleteTimeType
{
