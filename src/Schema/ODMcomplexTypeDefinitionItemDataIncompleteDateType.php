...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataIncompleteDateType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataIncompleteDate
 */
class ODMcomplexTypeDefinitionItemDataIncompleteDateType
{
