...
/**
 * Class representing ODMcomplexTypeDefinitionItemDataFloatType
 *
 *
 * XSD Type: ODMcomplexTypeDefinition-ItemDataFloat
 */
class ODMcomplexTypeDefinitionItemDataFloatType
{
